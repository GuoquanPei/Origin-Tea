...
class MobileNetV3_Tea_s1s2_9MB(nn.Module):
    def __init__(self, num_classes=6, act=nn.Hardswish):
        super(MobileNetV3_Tea_s1s2_9MB, self).__init__()
        ...
        self.bneck = nn.Sequential(
            ...
            Block(5, 96, 576, 96, act, True, 1),
            Block(5, 96, 576, 96, act, True, 1),  # 新增一层 Block
        )
...
if __name__ == '__main__':
    ...
    model = net = MobileNetV3_Tea_s1s2_9MB(num_classes=6).to(device)
    # print(model)
