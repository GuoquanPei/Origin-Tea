...
class MobileNetV3_Tea_0MB(nn.Module):
    def __init__(self, num_classes=6, act=nn.Hardswish):
        super(MobileNetV3_Tea_0MB, self).__init__()

        # Ensure conv_3x3_bn and MBConv are defined properly
...
if __name__ == '__main__':
    ...
    model = net = MobileNetV3_Tea_0MB(num_classes=5).to(device)
    # print(model)
