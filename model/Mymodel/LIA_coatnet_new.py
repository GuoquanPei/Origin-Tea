...
class CoAtNet(nn.Module):
    def __init__(self, image_size, in_channels, num_blocks, channels, num_classes=5,
                 block_types=['C', 'C', 'T', 'T']):
        super().__init__()
        ih, iw = image_size
        block = {'C': MBConv, 'T': Transformer}
        self.LIA = LocalAttention(channels=3)
...
def LIA_coatnet_0():
    ...
    channels = [64, 96, 192, 384, 192]  # D
    return CoAtNet((224, 224), 3, num_blocks, channels, num_classes=5)
